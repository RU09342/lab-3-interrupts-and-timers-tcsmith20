...
/** Assigns register pointers to variables depending on target specified processor */
    ...
    volatile unsigned int  *  control_reg =         &TA0CTL;
    volatile unsigned int * counter_reg =           &TA0R;
    volatile unsigned int  *  ccr0_reg =            &TA0CCR0;
    volatile unsigned int  *  ccr0_control_reg =    &TA0CCTL0;
    unsigned int ccr0_interrupt_enable =            CCIE;
    ...
    volatile unsigned int  *  control_reg =         &TB0CTL;
    volatile unsigned int * counter_reg =           &TB0R;
    volatile unsigned int  *  ccr0_reg =            &TB0CCR0;
    volatile unsigned int  *  ccr0_control_reg =    &TB0CCTL0;
    unsigned int ccr0_interrupt_enable =            CCIE;
